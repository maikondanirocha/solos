...
const Index = () => {
  ...
  return (
    <>
      {/* Hero */}
      <section className="relative min-h-[100vh] flex items-center bg-solos-dark overflow-hidden">
        <div className="absolute inset-0">
          <img
            src={heroImg}
            alt="Casa contemporânea Solos ao entardecer"
            className="w-full h-full object-cover"
            width={1920}
            height={1080}
          />
          <div className="absolute inset-0 bg-gradient-to-r from-solos-dark via-solos-dark/80 to-solos-dark/20" />
          <div className="absolute inset-0 bg-gradient-to-t from-solos-dark/80 via-transparent to-solos-dark/60" />
        </div>
        <div className="relative container mx-auto px-4 lg:px-8 pt-40 pb-24">
